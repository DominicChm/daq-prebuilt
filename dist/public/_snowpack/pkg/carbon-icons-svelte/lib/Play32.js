...
/* node_modules\carbon-icons-svelte\lib\Play32\Play32.svelte generated by Svelte v3.46.4 */
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(path, "d", "M7,28a1,1,0,0,1-1-1V5a1,1,0,0,1,1.4819-.8763l20,11a1,1,0,0,1,0,1.7525l-20,11A1.0005,1.0005,0,0,1,7,28ZM8,6.6909V25.3088L24.9248,16Z");
...
class Play32 extends SvelteComponent {
	constructor(options) {
		super();
