...
/* node_modules\carbon-icons-svelte\lib\Recording32\Recording32.svelte generated by Svelte v3.46.4 */
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(path0, "d", "M16,4A12,12,0,1,1,4,16,12,12,0,0,1,16,4m0-2A14,14,0,1,0,30,16,14,14,0,0,0,16,2Z");
			attr(path1, "d", "M16,12a4,4,0,1,1-4,4,4,4,0,0,1,4-4m0-2a6,6,0,1,0,6,6,6,6,0,0,0-6-6Z");
...
class Recording32 extends SvelteComponent {
	constructor(options) {
		super();
