...
/* node_modules\carbon-icons-svelte\lib\Archive16\Archive16.svelte generated by Svelte v3.46.4 */
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(path0, "d", "M14 19H18V21H14z");
			attr(path1, "d", "M6,2V28a2,2,0,0,0,2,2H24a2,2,0,0,0,2-2V2ZM24,28H8V16H24Zm0-14H8V10H24ZM8,8V4H24V8Z");
...
class Archive16 extends SvelteComponent {
	constructor(options) {
		super();
