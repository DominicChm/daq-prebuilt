...
/* node_modules\carbon-icons-svelte\lib\Reset32\Reset32.svelte generated by Svelte v3.46.4 */
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			attr(path, "d", "M18,28A12,12,0,1,0,6,16v6.2L2.4,18.6,1,20l6,6,6-6-1.4-1.4L8,22.2V16H8A10,10,0,1,1,18,26Z");
...
class Reset32 extends SvelteComponent {
	constructor(options) {
		super();
